...
model StartASMA "Compares U/f=cost and mains start-ups"
  ...
  Modelica.Electrical.Polyphase.Sources.SignalVoltage signalV annotation (
     Placement(transformation(origin = {-72, 53}, extent = {{-10, -9}, {10, 9}}, rotation = 180)));
  ...
  Modelica.Electrical.Polyphase.Sensors.AronSensor pDown annotation(
    Placement(transformation(origin = {-42, -34}, extent = {{-8, -8}, {8, 8}})));
  Modelica.Electrical.Polyphase.Sensors.AronSensor pUp annotation(
    Placement(transformation(origin = {-44, 54}, extent = {{-8, -8}, {8, 8}})));
equation
  ...
  connect(actuator.U, signalV.v) annotation(
    Line(points = {{-85.1, 10}, {-88, 10}, {-88, 40}, {-72, 40}, {-72, 42}}, color = {0, 0, 127}));
  connect(signalV.plug_n, star.plug_p) annotation(
    Line(points = {{-82, 53}, {-102, 53}, {-102, 48}}, color = {0, 0, 255}));
  connect(sineVoltage.plug_n, pDown.plug_p) annotation(
    Line(points = {{-58, -34}, {-50, -34}}, color = {0, 0, 255}));
  connect(Idown.plug_p, pDown.plug_n) annotation(
    Line(points = {{-14, -30}, {-22, -30}, {-22, -34}, {-34, -34}}, color = {0, 0, 255}));
  connect(signalV.plug_p, pUp.plug_p) annotation(
    Line(points = {{-62, 53}, {-57, 53}, {-57, 54}, {-52, 54}}, color = {0, 0, 255}));
