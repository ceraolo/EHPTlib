...
model AsmaTqFollowing "Compares U/f=cost and mains start-ups"
  ...
  EHPTlib.ElectricDrives.ASMArelated.ControlLogic logic(Lstray = aimc.Lssigma + aimc.Lrsigma, Rr = aimc.Rr, Rs = aimc.Rs, pp = aimc.p, uBase = 200*sqrt(3), weBase = 500, wmMax = 314.16) annotation(
...
equation
  ...
  annotation(
    Documentation(info = "<html><head></head><body><p>This system simulates variable-frequency start-up of an asyncronous motor.</p>
      ...
      <p>When the final speed is reached, the feeding frequency and voltage are kept constant (no flux weaking simulated)</p>
      </body></html>"),
