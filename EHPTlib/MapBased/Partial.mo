...
<p>This model is not parameter-compatible with OneFlange. This has caused this new model to be introduced. </p>
    ...
    model PartialOneFlangeCTCT "Simple map-based model of an electric drive"
      extends PartialOneFlangeBase;
...
<p>This model is not parameter-compatible with OneFlange. This has caused this new model to be introduced. </p>
    ...
    model PartialOneFlangeCTLF "Simple map-based model of an electric drive"
      extends PartialOneFlangeBase;
