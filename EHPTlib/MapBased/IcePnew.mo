...
model IcePnew "Extends PartialIce0 adding power input"
  extends Partial.PartialIceP;

  Modelica.Blocks.Interfaces.RealInput powRef "torque request (positive when motor)" annotation (
    Placement(transformation(extent = {{-20, -20}, {20, 20}}, rotation = 90, origin={-88,-120}),    iconTransformation(extent = {{-20, -20}, {20, 20}}, rotation = 90, origin = {-60, -100})));
...
equation
  ...
  connect(limiter.y, feedback.u1) annotation (Line(points={{-88,-25},{-88,24},{
          -104,24},{-104,52},{-88,52}}, color={0,0,127}));
  annotation (
