...
model IceT
  ...
  Modelica.Blocks.Sources.BooleanConstant onSignal
    annotation (Placement(transformation(extent={{-50,-56},{-34,-40}})));
equation
  ...
  connect(limiter.u, tauRef)
    annotation (Line(points={{-80,-68},{-80,-96},{-60,-96},{-60,-122}},
                                                    color={0,0,127}));
  connect(onSignal.y, switch1.u2) annotation (Line(points={{-33.2,-48},{-22,-48},
          {-22,-52},{-4,-52}}, color={255,0,255}));
