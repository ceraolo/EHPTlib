...
equation
  connect(gms.Wmecc, gain1.y) annotation (Line(points={{-59.9,6.5},{-60,6},{-60,
          -1.4}}, color={0,0,127}));
  connect(gms.throttle, iceT.nTauRef) annotation (Line(points={{-49,12},{-44,12},
          {-44,-10},{-30,-10},{-30,-2.22}}, color={0,0,127}));
  connect(gms.pRef, limiter.y)
    annotation (Line(points={{-72,18},{-80,18},{-80,43}}, color={0,0,127}));
  connect(gain.u, gms.tRef) annotation (Line(points={{-16,40},{-40,40},{-40,24},
          {-49,24}}, color={0,0,127}));
